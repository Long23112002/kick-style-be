...
import org.longg.nh.kickstyleecommerce.domain.dtos.filter.UserParam;
import org.longg.nh.kickstyleecommerce.domain.dtos.requests.UserRequest;
...
public class UserService implements IBaseService<User , Long , UserResponse , UserRequest , UserParam> {
