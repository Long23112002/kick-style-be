...
public class OrderController {
  ...
  public ResponseEntity<OrderResponse> createOrder(
      ...
      @Valid @RequestBody @Parameter(description = "Thông tin đơn hàng cần tạo") CreateOrderRequest request,
  ...
  @Operation(summary = "Lấy thông tin đơn hàng theo ID", description = "Lấy chi tiết thông tin của một đơn hàng dựa vào ID")
  @ApiResponses(value = {
  ...
  @Operation(summary = "Lấy thông tin đơn hàng theo mã", description = "Lấy chi tiết thông tin của một đơn hàng dựa vào mã đơn hàng")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Lấy thông tin đơn hàng thành công",
                  content = @Content(schema = @Schema(implementation = OrderResponse.class))),
      @ApiResponse(responseCode = "404", description = "Không tìm thấy đơn hàng")
  ...
  @Operation(summary = "Lấy danh sách đơn hàng của người dùng", description = "Lấy tất cả đơn hàng của một người dùng cụ thể")
  @ApiResponses(value = {
  ...
  @Operation(summary = "Lấy danh sách tất cả đơn hàng", description = "Lấy danh sách tất cả đơn hàng với phân trang")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Lấy danh sách đơn hàng thành công")
  })
  @GetMapping
  ...
  @Operation(summary = "Cập nhật trạng thái thanh toán", description = "Cập nhật trạng thái thanh toán của đơn hàng")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Cập nhật trạng thái thanh toán thành công",
                  content = @Content(schema = @Schema(implementation = OrderResponse.class))),
      @ApiResponse(responseCode = "404", description = "Không tìm thấy đơn hàng")
  })
  ...
  public ResponseEntity<OrderResponse> updatePaymentStatus(
      @Parameter(hidden = true) HeaderContext context,
      @PathVariable @Parameter(description = "ID đơn hàng") Long id,
      @RequestParam @Parameter(description = "Trạng thái thanh toán mới") PaymentStatus paymentStatus) {
